...
<jsp:include page="../content_header.jsp"></jsp:include>
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col">
                    <f:form action="account-insert.htm" commandName="account-insert">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <f:password path="passWord" class="form-control"/></div>
                        </div>
                        <div class="form-group">
                            <h5>Loại</h5>
                            <div class="controls">
    ...
    <!-- /.box -->
    <script>
        $('#account-insert').submit(function (e) {
            e.preventDefault();
            $.ajax({
                url: 'account-insert.htm',
                type: 'POST',
                data: $(this).serialize(),
                dataType: 'json',
